                    ...
                    <tr>
                        <th scope="col" className="p-4">
                            <div className="flex items-center">
                                ...
                                <label id="checkbox-all-search" className="sr-only">checkbox</label>
                            </div>
                        </th>
                        ...
                        <div className="p-6 space-y-6">
                            <div className="grid grid-cols-6 gap-6">
                                <div className="col-span-6 sm:col-span-3">
                                    <label id="first-name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">First Name</label>
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label id="last-name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last Name</label>
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label id="phone-number" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone Number</label>
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label id="department" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Department</label>
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label id="company" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Company</label>
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label id="current-password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Current Password</label>
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label id="new-password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">New Password</label>
